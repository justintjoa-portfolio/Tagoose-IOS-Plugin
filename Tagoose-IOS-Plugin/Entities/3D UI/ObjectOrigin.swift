...
class ObjectOrigin: SCNNode {
    ...
    init(extent: float3, _ sceneView: ARSCNView, url:URL) {
        ...
        set3DModel(url, extentForScaling: extent, sceneView: sceneView)
        isHidden = true
    }
    
    func set3DModel(_ url: URL?, extentForScaling: float3?=nil, sceneView:ARSCNView) {
